...
import id.ac.amikom.appstore.app.databinding.FragmentNewsBinding
import id.ac.amikom.appstore.app.ui.home.MainActivity
...
class NewsFragment : Fragment() {
    ...
    private fun init() {
        binding.recyclrerView.adapter = NewsAdapter(parent)
        viewModel.listNews()
    }
