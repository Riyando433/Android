package id.ac.amikom.appstore.app.ui.base
...
import id.ac.amikom.appstore.app.BR

abstract class BaseAdapter<T>(@field:LayoutRes private var layoutTd:Int) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
     val itemView = LayoutInflater.from(parent.context).inflate(layoutTd, parent, false)
